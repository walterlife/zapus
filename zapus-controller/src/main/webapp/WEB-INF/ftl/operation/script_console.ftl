...
- agentManager (com.dianwoba.zapus.perftest.service.AgentManager)
- agentManagerService (com.dianwoba.zapus.agent.service.AgentManagerService)
- regionService (com.dianwoba.zapus.region.service.RegionService)
- consoleManager (com.dianwoba.zapus.perftest.service.ConsoleManager)
- userService (com.dianwoba.zapus.user.service.UserService)
- perfTestService  (com.dianwoba.zapus.perftest.service.PerfTestService)
- tagService (com.dianwoba.zapus.perftest.service.TagService)
- fileEntryService	(com.dianwoba.zapus.script.service.FileEntryService)
- config (com.dianwoba.zapus.infra.config.Config)
- pluginManager (com.dianwoba.zapus.infra.plugin.PluginManager)
