 ...
 */
package com.dianwoba.zapus.common.model;
...
import com.dianwoba.zapus.common.util.EncodingUtils;
import com.dianwoba.zapus.common.constants.GrinderConstants;
import com.dianwoba.zapus.common.exception.ConfigurationException;
import com.dianwoba.zapus.common.util.NoOp;
...
/**
 * Home class which enables the easy resource access in ${ZAPUS_HOME}
 * directory.
 *
 * @author JunHo Yoon
 * @since 3.0
...
public class Home {
	 ...
	 * Constructor.
	 *
	 * @param directory home directory ${ZAPUS_HOME}
	 ...
	 * @param subPath  subPath
	 * @return {@link ZapusPerftest} sub directory.
	 */
	private File getPerfTestSubDirectory(ZapusPerftest perfTest, String subPath) {
	...
	/**
	 * Get the root directory for given {@link ZapusPerftest} id.
	 *
	 * @param perfTest perftest
	 * @return {@link ZapusPerftest} log directory
	 */
	...
	/**
	 * Get the log directory for given {@link ZapusPerftest} id.
	 *
	 * @param id perftest id
	 * @return {@link ZapusPerftest} log directory
	 */
	...
	/**
	 * Get the log directory for given {@link ZapusPerftest}.
	 *
	 * @param perfTest perftest
	 * @return {@link ZapusPerftest} log directory
	 */
	public File getPerfTestLogDirectory(ZapusPerftest perfTest) {
		return getPerfTestSubDirectory(perfTest, PATH_LOG);
	}

	/**
	 * Get the distribution directory for given {@link ZapusPerftest}.
	 *
	 * @param perfTest perftest
	 * @return {@link ZapusPerftest} distribution directory
	 */
	public File getPerfTestDistDirectory(ZapusPerftest perfTest) {
		return getPerfTestSubDirectory(perfTest, PATH_DIST);
	}

	/**
	 * Get the statistics directory for given {@link ZapusPerftest}.
	 *
	 * @param perfTest perftest
	 * @return {@link ZapusPerftest} statistics directory
	 */
	public File getPerfTestStatisticPath(ZapusPerftest perfTest) {
		return getPerfTestSubDirectory(perfTest, PATH_STAT);
	}

	/**
	 * Get the report directory for given {@link ZapusPerftest} id.
	 *
	 * @param id perftest id
	 * @return {@link ZapusPerftest} report directory
	 */
	...
	/**
	 * Get the report directory for given {@link ZapusPerftest}.
	 *
	 * @param perfTest perftest
	 * @return {@link ZapusPerftest} report directory
	 */
	public File getPerfTestReportDirectory(ZapusPerftest perfTest) {
		return getPerfTestSubDirectory(perfTest, PATH_REPORT);
	}

	/**
	 * Get the csv file for given {@link ZapusPerftest}.
	 *
	 * @param perfTest perftest
	 * @return {@link ZapusPerftest} csv file
	 */
	public File getPerfTestCsvFile(ZapusPerftest perfTest) {
