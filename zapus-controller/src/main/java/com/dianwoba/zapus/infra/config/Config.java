 ...
 */
package com.dianwoba.zapus.infra.config;
...
import com.dianwoba.zapus.common.constant.ClusterConstants;
import com.dianwoba.zapus.common.constant.ControllerConstants;
import com.dianwoba.zapus.common.constants.InternalConstants;
import com.dianwoba.zapus.common.exception.ConfigurationException;
import com.dianwoba.zapus.common.model.Home;
import com.dianwoba.zapus.common.util.FileWatchdog;
import com.dianwoba.zapus.common.util.PropertiesKeyMapper;
import com.dianwoba.zapus.common.util.PropertiesWrapper;
import com.dianwoba.zapus.infra.logger.CoreLogger;
import com.dianwoba.zapus.infra.spring.SpringContext;
import com.dianwoba.zapus.service.AbstractConfig;
...
import static com.dianwoba.zapus.common.constant.DatabaseConstants.PROP_DATABASE_UNIT_TEST;
import static com.dianwoba.zapus.common.util.Preconditions.checkNotNull;

/**
 * Spring component which is responsible to get the nGrinder configurations which is stored ${ZAPUS_HOME}.
 *
 * @author JunHo Yoon
 * @since 3.0
 */
...
public class Config extends AbstractConfig implements ControllerConstants, ClusterConstants,
	...
	private static final String NGRINDER_DEFAULT_FOLDER = ".zapus";
	private static final String NGRINDER_EX_FOLDER = ".zapus_ex";
	 ...
	 * <p/>
	 * This method mainly resolves ${ZAPUS_HOME} and loads system properties. In addition, the logger is initialized
	 * and the default configuration files are copied into ${ZAPUS_HOME} if they do not exists.
	 */
	@PostConstruct
	public void init() {
		try {
			CoreLogger.LOGGER.info("zapus is starting...");
			home = resolveHome();
			home.init();
	...
	/**
	 * Copy the default files and create default directories to ${ZAPUS_HOME}.
	 *
	 * @throws IOException occurs when there is no such a files.
	 */
	protected void copyDefaultConfigurationFiles() throws IOException {
		checkNotNull(home);
		home.copyFrom(new ClassPathResource("ZAPUS_HOME_template").getFile());
	}
	...
	protected Home resolveHome() {
		...
		String userHomeFromEnv = System.getenv("ZAPUS_HOME");
		...
		if (!StringUtils.equals(userHomeFromEnv, userHomeFromProperty)) {
			...
			CoreLogger.LOGGER.warn("    System Environment:  ZAPUS_HOME=" + userHomeFromEnv);
	...
	protected void loadDatabaseProperties() {
		...
		properties.put("ZAPUS_HOME", home.getDirectory().getAbsolutePath());
