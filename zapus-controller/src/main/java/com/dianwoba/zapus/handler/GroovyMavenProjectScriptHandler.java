...
public class GroovyMavenProjectScriptHandler extends GroovyScriptHandler implements ProjectHandler {
	...
	@Override
	public List<FileEntry> getLibAndResourceEntries(ZapusUser user, FileEntry scriptEntry, long revision) {
	...
	@Override
	protected void prepareDistMore(Long testId, ZapusUser user, FileEntry script, File distDir,
	...
	@Override
	public boolean prepareScriptEnv(ZapusUser user, String path, String fileName, String name, // LF
	...
	private void createLibraryDirectory(ZapusUser user, String path) {
	...
	private void createFileEntries(ZapusUser user, String path, String name, String url,
	...
	private void createBaseDirectory(ZapusUser user, String path) {
	 ...
	 * 
	 * @see
	 * com.dianwoba.zapus.handler.ScriptHandler#getBasePath(java.lang.String)
	 */
	@Override
