...
import com.dianwoba.zapus.common.util.FileUtils;
...
public abstract class ScriptHandler implements ControllerConstants {
	 ...
	 */
	public boolean prepareScriptEnv(ZapusUser user, String path, String fileName, String name, String url,
	 ...
	 * @param processingResult processing result holder
	 */
	protected void prepareDistMore(Long testCaseId, ZapusUser user, FileEntry script, File distDir,
