...
import static com.dianwoba.zapus.common.util.CollectionUtils.buildMap;
...
import com.dianwoba.zapus.common.util.ThreadUtils;
import com.dianwoba.zapus.common.util.UrlUtils;
import com.dianwoba.zapus.infra.config.Config;
import com.dianwoba.zapus.model.ZapusUser;
import com.dianwoba.zapus.handler.ProjectHandler;
...
import com.dianwoba.zapus.script.repository.FileEntryRepository;
...
public class FileEntryService {
	 ...
	 */
	@Async
	public void prepare(ZapusUser user) {
	...
	private SVNURL createUserRepo(ZapusUser user, File newUserDirectory) throws SVNException {
		return svnClientManager.getAdminClient().doCreateRepository(newUserDirectory, user.getUserId(), true, true);
	}

	private File getUserRepoDirectory(ZapusUser user) {
	...
	public List<FileEntry> getAll(ZapusUser user) {
		prepare(user);
	 ...
	 */
	public List<FileEntry> getAll(ZapusUser user, String path, Long revision) {
	 ...
	 * @return file entity
	 */
	public FileEntry getOne(ZapusUser user, String path, Long revision) {
	 ...
	 */
	public FileEntry getOne(ZapusUser user, String path) {
	 ...
	 */
	public boolean hasFileEntry(ZapusUser user, String path) {
	 ...
	 */
	public void addFolder(ZapusUser user, String path, String folderName, String comment) {
	 ...
	 */
	public void save(ZapusUser user, FileEntry fileEntry) {
		prepare(user);
	 ...
	 */
	public void delete(ZapusUser user, String basePath, String[] files) {
	 ...
	 * @param path the path
	 */
	public void delete(ZapusUser user, String path) {
	 ...
	 */
	public FileEntry prepareNewEntry(ZapusUser user, String path, String fileName, String name, String url,
	 ...
	 */
	public FileEntry prepareNewEntryForQuickTest(ZapusUser user, String url,
	 ...
	 */
	public String loadTemplate(ZapusUser user, ScriptHandler handler, String url, String name,
		String options) {
	 ...
	 */
	public void writeContentTo(ZapusUser user, String fromPath, File toDir) {
