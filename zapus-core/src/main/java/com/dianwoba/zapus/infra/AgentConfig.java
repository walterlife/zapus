 ...
 */
package com.dianwoba.zapus.infra;

import ch.qos.logback.classic.joran.JoranConfigurator;
import ch.qos.logback.core.Context;
import ch.qos.logback.core.joran.spi.JoranException;
import com.dianwoba.zapus.common.constants.AgentConstants;
import com.dianwoba.zapus.common.constants.MonitorConstants;
import com.dianwoba.zapus.common.util.ExceptionUtils;
...
import com.dianwoba.zapus.common.constants.CommonConstants;
...
public class AgentConfig implements AgentConstants, MonitorConstants, CommonConstants {
	...
	public PropertiesWrapper getAgentProperties() {
		return Preconditions.checkNotNull(agentProperties);
	}
	...
	public PropertiesWrapper getMonitorProperties() {
		return Preconditions.checkNotNull(monitorProperties);
	}
